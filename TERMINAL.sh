...
sleep 2
echo "Nama gw Mr.R3f4ll :v Orang terganss... di masanya"|lolcat
sleep 2
echo ""
...
echo $yellow "+===========(Mr.R3f4ll)===========+"
echo $green "|+TOOLS  : Terminal             |"
echo $green  "|+CODING : Mr.R3f4ll           |"
echo $yellow "|+CONTAC : 082236299010.       |"
echo $yellow "|+THANKS TO : •UCA•            |"
echo $yellow "|+Instagram : r3f4ll_          |"
echo $yellow "|+Kumpulan terminal pc no root |"
echo $yellow "|~Special Thanks to Mr.R3f4ll  |"
echo $yellow "+==========[UCA]===========+"
echo $blue ">>=========={MENU}==========<<"
...
echo " Info"|lolcat
sleep 0.1
echo "Tools ini di buat oleh Mr.R3f4ll"|lolcat
sleep 0.2
echo "Ini No root ya gan"|lolcat
sleep 0.2
echo "follow ig r3f4ll_"|lolcat
sleep 0.2
echo "yang mau Kerjasama"|lolcat
sleep 0.2
echo "Yang baek , kirim pulsa 5k :v"|lolcat
sleep 0.2
echo "082236299010"|lolcat
fi
...
echo "Ni contak gw : 082236299010"|lolcat
